...
const (
	GameService_GetGame_FullMethodName    = "/grpcgames.GameService/GetGame"
	GameService_CreateGame_FullMethodName = "/grpcgames.GameService/CreateGame"
)
...
func (c *gameServiceClient) CreateGame(ctx context.Context, in *Game, opts ...grpc.CallOption) (*Game, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Game)
...
func (UnimplementedGameServiceServer) CreateGame(context.Context, *Game) (*Game, error) {
...
func _GameService_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServiceServer).CreateGame(ctx, req.(*Game))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GameService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpcgames.GameService",
